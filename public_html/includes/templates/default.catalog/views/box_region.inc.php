<ul id="region" class="nav navbar-nav navbar-right">
  <li class="region dropdown">
    <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog" aria-hidden="true"></i></a>
    <ul class="dropdown-menu region-dropdown">
      <li>
        ...
        <div class="change"><a href="<?php echo document::href_ilink('regional_settings'); ?>" data-toggle="lightbox" class="btn btn-default"><?php echo functions::draw_fonticon('fa-pencil'); ?></a></div>
      </li>
    </ul>
  </li>
</ul>