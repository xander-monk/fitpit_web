...
if (!empty($_COOKIE['sb_lang']) && array_key_exists($_COOKIE['sb_lang'], $langList)) {
	$lang = preg_replace("/[^a-z0-9_]/i", "", $_COOKIE['sb_lang']);
} else if(!empty($sbconfig['defaultLanguage']) && array_key_exists($sbconfig['defaultLanguage'], $langList)) {
	$lang = $sbconfig['defaultLanguage'];
} else {
	$lang = "en_US";
}
...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo smartCaching("assets/css/common.css"); ?>" media="all" />
		<link type="text/css" rel="stylesheet" href="<?php echo smartCaching("assets/css/navigation.css"); ?>" media="all" />
		<link type="text/css" rel="stylesheet" href="<?php echo smartCaching("assets/css/print.css"); ?>" media="print" />
		<link type="text/css" rel="stylesheet" href="<?php echo themeFile("css/main.css"); ?>" media="all" />
		<script type="text/javascript" src="<?php echo smartCaching("assets/js/mootools-1.2-core.js"); ?>"></script>
		<script type="text/javascript" src="<?php echo smartCaching("assets/js/helpers.js"); ?>"></script>
		<script type="text/javascript" src="<?php echo smartCaching("assets/js/core.js"); ?>"></script>
		<script type="text/javascript" src="<?php echo smartCaching("assets/js/movement.js"); ?>"></script>
	</head>
	<body>
		<div id="container">
			<div id="header">
				<div id="headerlogo">
					<a href="#page=home" onclick="sideMainClick('home.php', 0); return false;"><img src="assets/images/logo.png" /></a>
				</div>
				<div id="toptabs">
					<ul></ul>
				</div>
...
function themeFile($filename) {
	global $theme;
	return smartCaching("assets/themes/" . $theme . "/" . $filename);
}
